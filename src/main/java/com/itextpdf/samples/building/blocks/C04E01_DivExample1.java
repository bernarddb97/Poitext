...
import com.itextpdf.samples.building.blocks.CsvTo2DList;
...
public class C04E01_DivExample1 {
	...
	public void createPdf(String dest) throws IOException {
		...
		for (List<String> record : resultSet) {
			...
			div.add(new Paragraph(movie.setFontSize(14))).add(new Paragraph(
					String.format("Directed by %s (%s, %s)", record.get(3), record.get(4), record.get(1))));
