...
public class AddPolygonLink extends GenericTest {
	...
	protected void manipulatePdf(String dest) throws Exception {
		...
		canvas.moveTo(36, 700).lineTo(72, 760).lineTo(144, 720).lineTo(72, 730).closePathStroke();
		...
		linkAnnotation.put(PdfName.QuadPoints, new PdfArray(new int[] { 72, 730, 144, 720, 72, 760, 36, 700 }));
