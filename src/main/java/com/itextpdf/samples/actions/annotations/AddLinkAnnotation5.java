package com.itextpdf.samples.actions.annotations;
/*
...
public class AddLinkAnnotation5 extends GenericTest {
	...
	protected void manipulatePdf(String dest) throws Exception {
		...
		String linkStr = "This is a link. Click it and you'll be forwarded to another page in this document.";
		Link link = new Link(linkStr, PdfAction.createGoTo(PdfExplicitDestination.createFit(3)));
