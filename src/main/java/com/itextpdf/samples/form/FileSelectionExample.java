...
public class FileSelectionExample extends GenericTest {
	...
	protected void manipulatePdf(String dest) throws Exception {
		...
		field.setAdditionalAction(PdfName.U, PdfAction.createJavaScript(
				"this.getField('myfile').browseForFileToSubmit();" + "this.getField('mytitle').setFocus();"));
		form.addField(field);

		PdfTextFormField title = PdfFormField.createText(pdfDoc, new Rectangle(36, 752, 523, 18), "mytitle", "");
		form.addField(title);
