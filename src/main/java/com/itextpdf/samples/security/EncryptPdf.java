package com.itextpdf.samples.security;
/*
...
//				new WriterProperties().setStandardEncryption("Hello".getBytes(), "World".getBytes(),
				new WriterProperties().setStandardEncryption(null, "World".getBytes(),
						EncryptionConstants.ALLOW_PRINTING | EncryptionConstants.ALLOW_COPY | EncryptionConstants.ALLOW_DEGRADED_PRINTING,
...
//			} else {
//				addError(compareTool.compareByContent(dest, cmp, outPath, differenceImagePrefix, "World".getBytes(),
//						"World".getBytes()));
//			}
