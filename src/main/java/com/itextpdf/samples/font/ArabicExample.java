package com.itextpdf.samples.font;
...
public class ArabicExample extends GenericTest {
	...
	public static final String DEST = "./target/test/resources/sandbox/fonts/arabic_example.pdf";
...
//		LicenseKey.loadLicenseFile(System.getenv("ITEXT7_LICENSEKEY") + "/itextkey-typography.xml");
		LicenseKey.loadLicenseFile("D:/work/poitext/iText_License" + "/itextkey1523332149167_0.xml");
		...
		p = new Paragraph("This is correct manual property: ").setBaseDirection(BaseDirection.LEFT_TO_RIGHT)
