...
public class C06E06_88th_Oscar_Combine_AddTOC {
	...
	public static final Map<String, Integer> nominations = new TreeMap<String, Integer>();
	static {
		nominations.put("Performance by an actor in a leading role", 4);
		nominations.put("Performance by an actor in a supporting role", 4);
		nominations.put("Achievement in cinematography", 4);
		nominations.put("Achievement in costume design", 5);
		nominations.put("Achievement in directing", 5);
		nominations.put("Achievement in film editing", 6);
		nominations.put("Achievement in makeup and hairstyling", 7);
		nominations.put("Best motion picture of the year", 8);
		nominations.put("Achievement in production design", 8);
		nominations.put("Achievement in sound editing", 9);
		nominations.put("Achievement in sound mixing", 9);
		nominations.put("Achievement in visual effects", 10);
	}
	...
	public void createPdf(String dest) throws IOException {
		...
		document.add(new Paragraph("The Revenant nominations list").setTextAlignment(TextAlignment.CENTER));

		PdfDocument firstSourcePdf = new PdfDocument(new PdfReader(SRC1));
		for (Map.Entry<String, Integer> entry : nominations.entrySet()) {
			// Copy page
